...
if __name__ == "__main__":
    ...
    parser.add_argument("--test_epochs", nargs="+", type=int, default=[1, 110, 210, 300, 400, 500, 600, 700, 800, 900, 1000])
    parser.add_argument("--save_epochs", nargs="+", type=int, default=[1, 110, 210, 300, 400, 500, 600, 700, 800, 900, 1000])
